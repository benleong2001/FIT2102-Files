...
-- `(<*>)` takes a function which produces a function for a given r,    func1 (r) (s) -> func_res (s)
--           and a function which produces a value for a given r,       func2 (r) -> value
--           and gives a function that applies:                         func -> 
...
instance Applicative RoseTree where
    ...
    (<*>) Nil _ = Nil
    (<*>) _ Nil = Nil
    (<*>) (Node fun fs) v@(Node val vs) = Node (fun val) (nestedMap fun vs ++ nestedApply fs v)
